  ...
  const sizes = [
    {
      key: "xs" as const,
      label: "Extra Small",
      description: "Height: 2px (0.125rem)",
    },
    {
      key: "sm" as const,
      label: "Small",
      description: "Height: 4px (0.25rem)",
    },
    {
      key: "md" as const,
      label: "Medium",
      description: "Height: 6px (0.375rem)",
    },
    {
      key: "lg" as const,
      label: "Large",
      description: "Height: 8px (0.5rem)",
    },
    {
      key: "xl" as const,
      label: "Extra Large",
      description: "Height: 12px (0.75rem)",
    },
  ];
