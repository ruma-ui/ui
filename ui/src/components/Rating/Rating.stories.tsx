...
const WithHoverFeedbackComponent = () => {
...
export const WithHoverFeedback: Story = {
  render: () => <WithHoverFeedbackComponent />,
};
...
export const CustomIcons: Story = {
  render: () => <CustomIconsComponent />,
};

const CustomIconThumbsComponent = () => {
  const [rating, setRating] = useState(3);
...
export const CustomIconThumbs: Story = {
  render: () => <CustomIconThumbsComponent />,
};
