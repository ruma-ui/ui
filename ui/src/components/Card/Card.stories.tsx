    ...
    children: (
      <div>
        ...
        <p className='text-gray-600'>
          This is a basic card component with default styling. It provides a clean, contained space
          for your content.
        </p>
      </div>
    ),
        ...
        <CardBody>
          <div className='space-y-3'>
            ...
            <p className='mt-3 text-gray-600'>
              Join us for an exciting tech conference featuring industry leaders and innovative
              workshops.
            </p>
          </div>
        </CardBody>
  ...
  args: {
    ...
    children: (
      <div>
        ...
        <p className='text-gray-600'>This card is disabled and cannot be interacted with.</p>
      </div>
    ),
  },
};
