...
import { Button, Form, FormField, TextInput, Textarea } from "../../";
      ...
      >
        <div className="space-y-3">
          ...
          <p className="text-sm text-gray-600">
            This is a popover component that can contain rich content like text, images, forms, and
            interactive elements. It&apos;s perfect for displaying contextual information without
    ...
    >
      ...
      >
        <div className="space-y-3">
          ...
          <p className="text-sm text-gray-600">
            Use the controls panel to experiment with different alignment options, offset values,
            and close behaviors.
          </p>
          <div className="flex justify-end space-x-2">
            <Button size="sm" variant="outline">
...
export const WithStartIcon: Story = {
  render: args => (
    <div className="space-y-2">
      ...
      <Popover {...args}>
        <PopoverTrigger asChild>
          <Button size="sm" variant="outline" startIcon={<FaCalendar />} endIcon={<FaInfoCircle />}>
            View Events
          </Button>
        </PopoverTrigger>
      ...
      <PopoverContent className="w-64 border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50">
        <div className="space-y-3 text-center">
          ...
          <p className="text-sm text-purple-700">
            Your support means the world to us. We appreciate you being part of our community!
          </p>
      ...
      <Popover {...args} trigger="focus">
        ...
        <PopoverContent className="w-64">
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-600">
              Enter your username or email address. This field is required and must be unique.
            </p>
          </div>
        </PopoverContent>
      </Popover>
...
const ControlledComponent = (args: Partial<typeof Popover.defaultProps>) => {
      ...
      <Popover {...args} open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent className="w-72">
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              This popover&apos;s state is controlled by the parent component. You can open and
        ...
        <Popover {...args}>
          ...
          <PopoverContent className="w-64" align="bottom-center">
            <div className="space-y-2 text-center">
              ...
              <p className="text-sm text-gray-600">
                This popover is perfectly centered below the trigger button, providing optimal
                visual balance.
              </p>
            </div>
          </PopoverContent>
        ...
        <Popover {...args} trigger="click">
          ...
          <PopoverContent className="w-64">
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600">
                This popover only responds to click events. Focus events are ignored.
              </p>
              <Button size="sm" variant="outline">
                Interactive Content
              </Button>
        ...
        <Popover {...args} trigger="focus">
          ...
          <PopoverContent className="w-64">
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600">
                Try focusing on the input, then tab to this content. The popover stays open!
              </p>
              <Button size="sm" variant="outline">
                Focusable Button
              </Button>
    ...
    <Popover {...args}>
      ...
      <PopoverContent className="w-64" closeOnClick>
        <div className="space-y-3">
          ...
          <p className="text-sm text-gray-600">
            This popover will close when you click anywhere inside it. Try clicking on this text or
            the button below.
          </p>
          <Button size="sm" fullWidth>
            Click Me (Will Close)
...
const WithFormComponent = (args: Partial<React.ComponentProps<typeof Popover>>) => {
...
export const WithForm: Story = {
  render: args => <WithFormComponent {...args} />,
};
