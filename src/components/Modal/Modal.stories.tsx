            ...
            {({ open, onClose }) => (
                <Modal open={open} onClose={onClose} title="Primary Modal" variant="primary">
                    <p className="text-gray-600">
                        This is a primary modal dialog. It uses the default styling with clean lines
                        and professional appearance suitable for most use cases.
                    </p>
                </Modal>
            )}
        </ModalWrapper>
        ...
        <ModalWrapper buttonVariant="secondary" buttonText="Open Secondary Modal">
            {({ open, onClose }) => (
                <Modal open={open} onClose={onClose} title="Secondary Modal" variant="secondary">
                    <p className="text-gray-600">
                        This is a secondary modal with subtle gray styling. Perfect for secondary
                        actions or when you need a softer visual presence.
                    </p>
                </Modal>
            )}
        </ModalWrapper>
        ...
        <ModalWrapper buttonText="Large Modal">
            {({ open, onClose }) => (
                <Modal open={open} onClose={onClose} size="lg" title="Large Modal">
                    <div className="space-y-4">
                        <p className="text-gray-600">
                            This is a large modal suitable for forms, detailed content, or complex
                            interactions that need more space.
                        </p>
                        <div className="rounded-lg bg-gray-50 p-4">
                            <h3 className="font-medium text-gray-900">Additional Content</h3>
                            <p className="mt-2 text-sm text-gray-600">
                                Large modals can accommodate more complex layouts and content while
                ...
                <Modal open={open} onClose={onClose} size="full" title="Full Size Modal">
                    <div className="space-y-6">
                        <p className="text-gray-600">
                            ...
                            margins. Perfect for forms, dashboards, or content-heavy interfaces.
                        </p>
                        <div className="grid gap-4 md:grid-cols-2">
                            <div className="rounded-lg bg-blue-50 p-4">
                                <h3 className="font-medium text-blue-900">Section 1</h3>
                                <p className="mt-2 text-sm text-blue-700">
                                    Full-size modals can contain complex layouts with multiple
                                    sections.
                                </p>
                            </div>
        ...
        <ModalWrapper buttonText="No Animation">
            {({ open, onClose }) => (
                <Modal open={open} onClose={onClose} title="No Animation" animation={false}>
                    <p className="text-gray-600">
                        This modal has animations disabled, which is useful for users who prefer
    ...
    render: () => (
        <ModalWrapper buttonText="No Close Button">
            {({ open, onClose }) => (
                ...
                >
                    <p className="text-gray-600">
                        This modal hides the default close button in favor of custom action buttons
                        in the footer.
                    </p>
                </Modal>
            )}
    ...
    render: () => (
        <ModalWrapper buttonText="Show Success" buttonVariant="secondary">
            {({ open, onClose }) => (
                ...
                >
                    <p className="text-gray-600">
                        Your action has been completed successfully. You can continue with your
                        workflow.
                    </p>
                </Modal>
            )}
    ...
    render: () => (
        <ModalWrapper buttonText="Custom Styled">
            {({ open, onClose }) => (
                ...
                >
                    <p className="text-gray-600">
                        This modal demonstrates custom styling with a gradient background and purple
                        theme to match your brand colors.
                    </p>
                </Modal>
            )}
        </ModalWrapper>
