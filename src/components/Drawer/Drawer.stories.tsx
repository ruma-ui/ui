            ...
            {({ open, onClose }) => (
                <Drawer open={open} onClose={onClose} title="Right Drawer" position="right">
                    <p className="text-gray-600">
                        This is a right-positioned drawer that slides in from the right side.
                        It&apos;s perfect for navigation menus, settings panels, or secondary
                        content.
                    </p>
                </Drawer>
            )}
        ...
        <DrawerWrapper buttonText="Open Left Drawer">
            {({ open, onClose }) => (
                <Drawer open={open} onClose={onClose} title="Left Drawer" position="left">
                    <p className="text-gray-600">
                        This is a left-positioned drawer that slides in from the left side. Commonly
                        used for main navigation or sidebar content.
                    </p>
                </Drawer>
            )}
        </DrawerWrapper>
        ...
        <DrawerWrapper buttonText="Open Top Drawer">
            {({ open, onClose }) => (
                <Drawer open={open} onClose={onClose} title="Top Drawer" position="top">
                    <p className="text-gray-600">
                        This is a top-positioned drawer that slides down from the top. Useful for
                        notifications, alerts, or dropdown-style interfaces.
                    </p>
                </Drawer>
            )}
        </DrawerWrapper>
            ...
            {({ open, onClose }) => (
                <Drawer open={open} onClose={onClose} title="Primary Drawer" variant="primary">
                    <p className="text-gray-600">
                        ...
                        styling. Use this for most drawer dialogs and primary content overlays.
                    </p>
                </Drawer>
            )}
        </DrawerWrapper>
        ...
        <DrawerWrapper buttonVariant="secondary" buttonText="Open Secondary Drawer">
            {({ open, onClose }) => (
                <Drawer open={open} onClose={onClose} title="Secondary Drawer" variant="secondary">
                    <p className="text-gray-600">
                        This is a secondary drawer with subtle gray styling. Perfect for secondary
                        contexts and when you need a softer visual presence.
                    </p>
                </Drawer>
            )}
        </DrawerWrapper>
        ...
        <DrawerWrapper buttonText="Large Drawer">
            {({ open, onClose }) => (
                <Drawer open={open} onClose={onClose} size="lg" title="Large Drawer">
                    <div className="space-y-4">
                        <p className="text-gray-600">
                            This is a large drawer that provides more space for complex forms,
                            detailed content, or interactions that need additional room.
                        </p>
                        <div className="rounded-lg bg-gray-50 p-4">
                            <h3 className="font-medium text-gray-900">Additional Content</h3>
                            <p className="mt-2 text-sm text-gray-600">
                                Large drawers can accommodate more complex layouts and content while
                                maintaining good usability and readability.
                            </p>
                        </div>
                    </div>
                </Drawer>
                ...
                <Drawer open={open} onClose={onClose} size="full" title="Full Size Drawer">
                    <div className="space-y-6">
                        <p className="text-gray-600">
                            ...
                            Perfect for complex interfaces or when you need maximum space.
                        </p>
                        <div className="grid gap-4 md:grid-cols-2">
                            <div className="rounded-lg bg-blue-50 p-4">
                                <h3 className="font-medium text-blue-900">Section 1</h3>
                                <p className="mt-2 text-sm text-blue-700">
                                    Full-size drawers can contain complex layouts with multiple
                                    sections.
                                </p>
                            </div>
                            <div className="rounded-lg bg-green-50 p-4">
                                ...
                                <p className="mt-2 text-sm text-green-700">
                                    They work well for admin panels, detailed forms, and data
                                    tables.
                                </p>
                            </div>
                        </div>
        ...
        <DrawerWrapper buttonText="No Animation">
            {({ open, onClose }) => (
                <Drawer open={open} onClose={onClose} title="No Animation" animation={false}>
                    <p className="text-gray-600">
                        This drawer has animations disabled, which is useful for users who prefer
                        reduced motion or in performance-critical scenarios.
                    </p>
                </Drawer>
            )}
        </DrawerWrapper>
            ...
            {({ open, onClose }) => (
                ...
                >
                    <div className="flex items-start gap-3">
                        ...
                        <p className="text-gray-600">
                            This drawer cannot be closed by clicking outside or pressing Escape. You
    ...
    render: () => (
        <DrawerWrapper buttonText="No Close Button">
            {({ open, onClose }) => (
                ...
                >
                    <p className="text-gray-600">
                        This drawer hides the default close button in favor of custom action buttons
                        in the footer.
                    </p>
                </Drawer>
            )}
    ...
    render: () => (
        <DrawerWrapper buttonText="Custom Styled">
            {({ open, onClose }) => (
                ...
                >
                    <p className="text-gray-600">
                        This drawer demonstrates custom styling with a gradient background and
                        purple theme to match your brand colors.
                    </p>
                </Drawer>
            )}
        </DrawerWrapper>
    ...
    render: (args) => {
        ...
        return (
            <div className="space-y-4">
                ...
                >
                    <p className="text-gray-600">
                        This drawer&apos;s open state is controlled by the parent component. You can
