        ...
        const getActionStyles = React.useCallback(
            (index: number): React.CSSProperties => {
                const mainButtonSize =
                    size === "sm" ? 40 : size === "md" ? 48 : size === "lg" ? 56 : 64;
                const spacing = 16;
                const edgeMargin = 24;

                const offset =
                    edgeMargin + mainButtonSize + spacing + index * (mainButtonSize + spacing);
        ...
        return (
            <>
                ...
                <button
                    ...
                    aria-busy={loading}
                    aria-label={
                        tooltip || (hasActions ? "Toggle actions" : "Floating action button")
                    }
