                    ...
                    <NavigationMenuItem value="projects">
                        ...
                        <NavigationMenuContent>
                            <NavigationMenuGroup title="Recent">
                                <NavigationMenuLink href="#project-1">
                                    Project Alpha
                                </NavigationMenuLink>
                                <NavigationMenuLink href="#project-2">
                                    Project Beta
                                </NavigationMenuLink>
                            </NavigationMenuGroup>
                            <NavigationMenuGroup title="Archived">
                                <NavigationMenuLink href="#archived-1">
                                    Old Project 1
                                </NavigationMenuLink>
                                <NavigationMenuLink href="#archived-2">
                                    Old Project 2
                                </NavigationMenuLink>
                            </NavigationMenuGroup>
                        </NavigationMenuContent>
                ...
                <NavigationMenuItem value="reports">
                    ...
                    <NavigationMenuContent>
                        <NavigationMenuGroup title="Report Types">
                            ...
                            <NavigationMenuLink href="#quarterly">
                                Quarterly Report
                            </NavigationMenuLink>
