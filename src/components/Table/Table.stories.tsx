...
const sampleData: UserRow[] = [
    { id: 1, name: "Alice Johnson", email: "alice@example.com", role: "Admin", usage: 76 },
    { id: 2, name: "Bob Carter", email: "bob@example.com", role: "Editor", usage: 34 },
    { id: 3, name: "Chen Li", email: "chen@example.com", role: "Viewer", usage: 12 },
    { id: 4, name: "Diego Santos", email: "diego@example.com", role: "Editor", usage: 58 },
    { id: 5, name: "Emma Brown", email: "emma@example.com", role: "Admin", usage: 91 },
];

const columns: Column<UserRow>[] = [
    { key: "name", header: "Name", sticky: true, width: "16rem", resizable: true, minWidth: 120 },
...
export const SimpleTest: Story = {
    args: {
        ...
        data: [
            { id: 1, name: "Test User", email: "test@example.com", role: "Admin", usage: 50 },
            {
                id: 2,
                name: "Another User",
...
export const AlignmentExample: StoryObj<typeof Table<AlignmentRow>> = {
    args: {
        columns: [
            { key: "name", header: "Product Name", align: "left", width: "200px" },
            { key: "count", header: "Quantity", align: "right", width: "120px" },
