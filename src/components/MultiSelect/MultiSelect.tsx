...
const sizes = {
    sm: { container: tw`min-h-8`, text: tw`text-xs`, padX: "px-2", padY: "py-1.5", gap: "gap-1.5" },
    md: { container: tw`min-h-9`, text: tw`text-sm`, padX: "px-3.5", padY: "py-2", gap: "gap-2" },
    lg: {
    ...
    (
        ...
        const displayText =
            selectedOptions.length > 0
                ? showSelectedCount
                    ? (selectedCountText || defaultSelectedCountText)(
