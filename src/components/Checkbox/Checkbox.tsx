        ...
        return (
            <div className="flex flex-col">
                ...
                >
                    ...
                    <div
                        className={cn("flex min-w-0 flex-col justify-center", textMinHeights[size])}
                    >
                        {label && (
                            <span
                                className={cn(
...
export const CheckboxGroup = React.forwardRef<HTMLDivElement, CheckboxGroupProps>(
    (
        ...
        const allSelected =
            selectedEnabledCount === enabledOptions.length && enabledOptions.length > 0;
        const indeterminate =
            selectedEnabledCount > 0 && selectedEnabledCount < enabledOptions.length;
