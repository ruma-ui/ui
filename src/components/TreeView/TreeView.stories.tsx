...
const meta: Meta<typeof TreeView> = {
    ...
    component: TreeView,
    subcomponents: { TreeItem, TreeItemContent, TreeItemTrigger, TreeItemChildren },
    parameters: {
        layout: "centered",
        docs: {
            page: mdx,
...
const sampleTreeData: TreeNode[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { id: "2-2", label: "Images", icon: <FaFolder className="h-4 w-4 text-green-500" /> },
        ],
    },
    { id: "3", label: "README.md", icon: <FaFile className="h-4 w-4 text-gray-500" /> },
];
