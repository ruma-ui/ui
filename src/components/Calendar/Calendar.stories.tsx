...
const meta: Meta<typeof CalendarNamed> = {
    ...
    argTypes: {
        selectedDate: { control: false, description: "Currently selected date" },
        onDateSelect: { action: "dateSelected", description: "Callback when a date is selected" },
        ...
        onMonthChange: { action: "monthChanged", description: "When visible month changes" },
