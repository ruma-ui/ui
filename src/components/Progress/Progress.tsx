...
// Sizes
const sizes = {
    sm: { track: tw`h-1`, fill: tw`h-1`, text: tw`text-xs`, circular: tw`h-12 w-12` },
    md: { track: tw`h-2`, fill: tw`h-2`, text: tw`text-sm`, circular: tw`h-16 w-16` },
    lg: { track: tw`h-3`, fill: tw`h-3`, text: tw`text-base`, circular: tw`h-20 w-20` },
};
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        {(label || showValue) && (
                            <div className="flex items-center justify-between">
                                ...
                                <div>
                                    {label && (
                                        <div className="flex-shrink-0 text-sm font-medium text-gray-800">
                                            {label}
                                        </div>
                                    )}
                                </div>
